...
<div class="main-content">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                <form action="hedeftakip2.php" method="POST">
                                    <label for="ay_secimi">İşlem Yapmak İstediğiniz Ay Seçiniz:</label>
                                    ...
                                    <br/>
                                    <input type="hidden" name="ay" id="ay" value="<?php echo $ay; ?>">
                            ...
                            <div class="responsive">
                                <table class="table table-striped table-bordered" id="employee_data">
                                    ...
                                    $statement = $pdoconnection->prepare("SELECT * FROM hedeftakip ORDER BY id ASC LIMIT 500");
                                    $statement->execute();
                                    ...
                                    <thead> 
                                        <tr>
                                            ...
                                            <th width="3%">'.$ayduzeltme[$ay].' Hedef</th>
                                            <th width="3%">'.$ayduzeltme[$ay].' Gerçekleşen</th>
                                            <th width="3%">Sapma(Fark)</th>
                                    ...
                                    if($statement->rowCount() > 0)
                                    {
                                        foreach($result as $row)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>'.$hedef.'</td>
                                                <td class="editable" data-id="'.$row['id'].'" data-ay="'.$ay.'">'.$gerceklesen.'</td>
                                                <td class="'.$sapmaClass.'"><b>'.(($hedef > $gerceklesen) ? '-' : '').abs($sapma).'</b></td>
    ...
    <script>
        ...
        $(document).on('click', '.delete', function(){
         ...
         //This JQuery code is for inline editing of "Gerçekleşen" column
        $(document).on('click', '.editable', function() {
            ...
            var input = $('<input>', {
                ...
                blur: function() {
                    ...
                    // Değeri sunucuya gönder
                    $.ajax({
                        url: "update_value.php",
                        method: "POST",
                        data: { id: id, ay: ay, value: newValue },
                        success: function(response) {
                            console.log(response);
                            // Hücreyi tekrar metin haline dönüştür
                            $this.text(newValue);
