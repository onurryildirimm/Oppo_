...
function fetchData($conn, $month) {
    $data = [];
    $sql = "SELECT * FROM energy_consumption WHERE month='$month' ORDER BY day";
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="energyTable" class="table table-bordered display nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th rowspan="2">GÜN</th>
                                ...
                                <tr>
                                    <th>T1 SAYAÇ DEĞER</th>
                                    <th>T2 SAYAÇ DEĞER</th>
                                    <th>T3 SAYAÇ DEĞER</th>
                                    <th>KAPASİTİF SAYAÇ DEĞER</th>
                                    <th>REAKTİF SAYAÇ DEĞER</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php for ($i = 1; $i <= 31; $i++): ?>
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td contenteditable="true" class="editable" data-day="<?php echo $i; ?>" data-month="<?php echo $month; ?>" data-field="T1"><?php echo isset($data[$i]['T1']) ? $data[$i]['T1'] : ''; ?></td>
                                    <td contenteditable="true" class="editable" data-day="<?php echo $i; ?>" data-month="<?php echo $month; ?>" data-field="T2"><?php echo isset($data[$i]['T2']) ? $data[$i]['T2'] : ''; ?></td>
                                    <td contenteditable="true" class="editable" data-day="<?php echo $i; ?>" data-month="<?php echo $month; ?>" data-field="T3"><?php echo isset($data[$i]['T3']) ? $data[$i]['T3'] : ''; ?></td>
                                    <td contenteditable="true" class="editable" data-day="<?php echo $i; ?>" data-month="<?php echo $month; ?>" data-field="kapasite"><?php echo isset($data[$i]['kapasite']) ? $data[$i]['kapasite'] : ''; ?></td>
                                    <td contenteditable="true" class="editable" data-day="<?php echo $i; ?>" data-month="<?php echo $month; ?>" data-field="reaktif"><?php echo isset($data[$i]['reaktif']) ? $data[$i]['reaktif'] : ''; ?></td>
                                </tr>
                                <?php endfor; ?>
                            </tbody>
                        </table>
...
$(document).ready(function() {
    ...
    $('.editable').on('blur', function() {
        ...
        let value = autoNumeric.getNumericString();
