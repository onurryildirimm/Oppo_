                        ...
                        <div class="card-body p-0">
                            <div class="alert alert-warning border-0 rounded-0 m-0 d-flex align-items-center <?php echo ($remainingDays < 30) ? 'blinking' : ''; ?>" role="alert">
                                ...
                                <div class="flex-grow-1 text-truncate">
                                    Kalan Lisans Süresi <b><?php echo "{$remainingDays} Gün."; ?></b>
                                    <style>
                                        @keyframes blink {
                                            50% {
                                                opacity: 0;
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="<?php echo getTotalUsers($connection); ?>">0</span></h2>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="<?php echo getOnlineUsers($connection); ?>">0</span></h2>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="<?php echo getOngoingJobs($connection); ?>">0</span> Adet</h2>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="<?php echo getTotalMalKabul($connection); ?>">0</span> Adet</h2>
