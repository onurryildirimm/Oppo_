...
$firmalaraOzelIsim = "lagunabeachalya"; // Firma A için
...
$id = $user['id'];
	try{//hata varmı diye kontrol mekanizması.
		...
		$baglanti=new PDO("mysql:host=localhost;dbname=greenga1_user","greenga1_onur","354472Onur");//bağlantı yaptık
...
//Application Title
define('APP_TITLE', 'Dosya Yönetim Sistemi');
...
if ($departman == "GENEL MÜDÜR" || $role == "admin") {
$root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/genel/dosyalar';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/genel/dosyalar';


}


else if ($departman == "ÖN BÜRO") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Ön Büro';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Ön Büro';
; }
...
else if ($departman == "SATINALMA") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Satın Alma';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Satın Alma';
; }

else if ($departman == "İNSAN KAYNAKLARI") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/İnsan Kaynakları';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/İnsan Kaynakları';
; }

else if ($departman == "MUTFAK") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Mutfak';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Mutfak';
; }

else if ($departman == "HOUSE KEEPING") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/House Keeping';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/House Keeping';
; }

else if ($departman == "KALİTE YÖNETİMİ") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Kalite Yönetimi';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Kalite Yönetimi';
; }

else if ($departman == "MİSAFİR İLİŞKİLERİ") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Misafir İlişkileri';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Misafir İlişkileri';
; }

else if ($departman == "TEKNİK SERVİS") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Teknik Servis';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Teknik Servis';
; }

else if ($departman == "SATIŞ PAZARLAMA") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Satış Pazarlama';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/genel/dosyalar/Satış Pazarlama';
; }
...
$allowed_upload_extensions = 'gif,png,jpg,html,txt,pdf,psd,rar';
...
$max_upload_size_bytes = 10000000000000;
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="VektraWeb - Dosya Yönetim Sistemi">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://www.vektraweb.com.tr" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">VektraWeb - Dosya Yönetim Sistemi</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://www.vektraweb.com.tr" target="_blank" class="app-v-title"> VektraWeb - Dosya Yönetim Sistemi <?php echo VERSION; ?></a></h3></p>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://www.vektraweb.com.tr" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://www.vektraweb.com.tr" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
    ...
    <div class="row">
        <div class="col-12">
            <?php if(!$quickView) { ?>
                ...
                <p class="break-word">
                    <strong>Dosya Boyut:</strong> <?php echo ($filesize_raw <= 1000) ? "$filesize_raw bytes" : $filesize; ?><br>
                    <strong>Tür:</strong> <?php echo $mime_type ?><br>
                    <?php
                    // ZIP info
...
if ($role == "admin") {
    echo '<a title="' . lng('Delete') . '" href="?p=' . urlencode(FM_PATH) . '&amp;del=' . urlencode($f) . '" onclick="confirmDailog(event, \'1028\',\'' . lng('Delete') . ' ' . lng('Folder') . '\',\'' . urlencode($f) . '\', this.href);"> <i class="fa fa-trash-o" aria-hidden="true"></i></a>';
    
    echo '<a title="' . lng('Rename') . '" href="#" onclick="rename(\'' . fm_enc(addslashes(FM_PATH)) . '\', \'' . fm_enc(addslashes($f)) . '\');return false;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>';
    
    echo '<a title="' . lng('CopyTo') . '..." href="?p=&amp;copy=' . urlencode(trim(FM_PATH . '/' . $f, '/')) . '"><i class="fa fa-files-o" aria-hidden="true"></i></a>';
}
?>
                        <?php endif; ?>
...
$id = $user['id'];
                if ($role == "user") {
                echo '<li class="list-inline-item"><input type="submit" class="hidden" name="delete" id="a-delete" value="Delete" onclick="return confirm(\'' . lng('Delete selected files and folders?') . '\')">';
                 echo '<a href="javascript:document.getElementById(\'a-delete\').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-trash"></i> ' . lng('Delete') . ' </a></li>';
                }
                ?>
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://www.vektraweb.com.tr" target="_blank" class="float-right text-muted">VektraWeb - Dosya Yönetim Sistemi <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://www.vektraweb.com.tr" target="_blank" class="float-right text-muted">VektraWeb - Dosya Yönetim Sistemi <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'VektraWeb - Dosya Yönetim Sistemi<br>Error: Ayar Yüklenemiyor';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
$role = $user['role'];
                    ...
                    <a title="' . lng('Upload') . '" class="nav-link" href="?p=' . urlencode(FM_PATH) . '&amp;upload">
                    <i class="fa fa-cloud-upload" aria-hidden="true"></i> ' . lng('Upload') . '
                     </a>
                    </li>';
                     ?>
                    <?php 
...
$role = $user['role'];
                    if ($role == "admin") {
    echo '<li class="nav-item">
            <a title="' . lng('NewItem') . '" class="nav-link" href="#createNewItem" data-bs-toggle="modal" data-bs-target="#createNewItem">
                <i class="fa fa-plus-square"></i> ' . lng('NewItem') . '
            </a>
          </li>';
}
?>
                    ...
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu text-small shadow <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
                            <?php if (!FM_READONLY): ?>
                            <a title="" class="dropdown-item nav-link" </a>
                            <?php endif ?>
...
<head>
    ...
    <meta name="description" content="VektraWeb - Dosya Yönetim Sistemi">
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="VektraWeb - Dosya Yönetim Sistemi">
    <meta name="author" content="VektraWeb - Dosya Yönetim Sistemi">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
    <title><?php echo fm_enc(APP_TITLE) ?></title>
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content <?php echo fm_get_theme(); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="newfilename" id="newfilename" value="" class="form-control" placeholder="Dosya, klasör ismini yazınız.." required>
                </div>
          ...
          <div class="modal-header">
            <h5 class="modal-title col-10" id="searchModalLabel">
                <div class="input-group mb-3">
                  <input type="text" class="form-control" placeholder="Dosya <?php echo lng('Search') ?>" aria-label="<?php echo lng('Search') ?>" aria-describedby="search-addon3" id="advanced-search" autofocus required>
          ...
          <div class="modal-body">
            <form action="" method="post">
                ...
                <ul id="search-wrapper">
                    <p class="m-2"><?php echo lng('Klasörlerde dosya araması yapın...') ?></p>
                </ul>
            </form>
          </div>
        </div>
      ...
      <div class="modal-dialog" role="document">
        <form class="modal-content rounded-3 shadow" method="post" autocomplete="off">
          <div class="modal-body p-4 text-center">
            <h5 class="mb-3">Yeniden Adlandırma Konusunda Emin Misiniz?</h5>
            <p class="mb-1">
                <input type="text" name="rename_to" id="js-rename-to" class="form-control" placeholder="Yeni İsim Giriniz" required>
                <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
                <input type="hidden" name="rename_from" id="js-rename-from">
            </p>
          </div>
          <div class="modal-footer flex-nowrap p-0">
            <button type="button" class="btn btn-lg btn-link fs-6 text-decoration-none col-6 m-0 rounded-0 border-end" data-bs-dismiss="modal">Vazgeç</button>
            <button type="submit" class="btn btn-lg btn-link fs-6 text-decoration-none col-6 m-0 rounded-0"><strong>Onayla</strong></button>
          </div>
        </form>
      </div>
    </div>
        ...
        <div class="modal modal-alert" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" id="confirmDailog-<%this.id%>">
          <div class="modal-dialog" role="document">
            <form class="modal-content rounded-3 shadow" method="post" autocomplete="off" action="<%this.action%>">
              <div class="modal-body p-4 text-center">
                <h5 class="mb-2">Bu Eylem İçin Emin Misiniz? : </h5>
                <p class="mb-1"><%this.content%></p>
              </div>
              <div class="modal-footer flex-nowrap p-0">
                <button type="button" class="btn btn-lg btn-link fs-6 text-decoration-none col-6 m-0 rounded-0 border-end" data-bs-dismiss="modal">Vazgeç</button>
                <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
                <button type="submit" class="btn btn-lg btn-link fs-6 text-decoration-none col-6 m-0 rounded-0" data-bs-dismiss="modal"><strong>Onayla</strong></button>
              </div>
            </form>
          </div>
        </div>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Dosya Yönetim Sistemi';      $tr['en']['AppTitle']           = 'Departman - Dosya Yükleme';
    $tr['en']['Login']          = 'Giriş Yap';                $tr['en']['Username']           = 'Kullanıcı Adı';
    $tr['en']['Password']       = 'Şifre';               $tr['en']['Logout']             = 'Çıkış Yap';
    $tr['en']['Move']           = 'Taşı';                   $tr['en']['Copy']               = 'Kopyala';
    $tr['en']['Save']           = 'Kaydet';                   $tr['en']['SelectAll']          = 'Tümünü Seç';
    $tr['en']['UnSelectAll']    = 'Seçimden Vazgeç';           $tr['en']['File']               = 'Dosya';
    $tr['en']['Back']           = 'Geri';                   $tr['en']['Size']               = 'Boyut';
    $tr['en']['Perms']          = 'İzinler';                  $tr['en']['Modified']           = 'Güncelleme';
    $tr['en']['Owner']          = 'Sahibi';                  $tr['en']['Search']             = 'Arama';
    $tr['en']['NewItem']        = 'Yeni Dosya';               $tr['en']['Folder']             = 'Klasör';
    $tr['en']['Delete']         = 'Sil';                 $tr['en']['Rename']             = 'Rename';
    $tr['en']['CopyTo']         = 'Hedefe Kopyala';                $tr['en']['DirectLink']         = 'Dosya Linki';
    $tr['en']['UploadingFiles'] = 'Dosya Yükle';           $tr['en']['ChangePermissions']  = 'İzinleri Değiştir';
    $tr['en']['Copying']        = 'Kopyalanıyor';                $tr['en']['CreateNewItem']      = 'Yeni Dosya Oluştur';
    $tr['en']['Name']           = 'İsim';                   $tr['en']['AdvancedEditor']     = 'Gelişmiş Editör';
    $tr['en']['RememberMe']     = 'Beni Hatırla';            $tr['en']['Actions']            = 'Aksiyonlar';
    $tr['en']['Upload']         = 'Yükle';                 
    $tr['en']['Cancel']             = 'İptal';
    $tr['en']['InvertSelection']= 'Seçim İptal';
    $tr['en']['DestinationFolder']  = 'Hedef Klasör';
    $tr['en']['ItemType']       = 'Dosya Türü';              
    $tr['en']['ItemName']           = 'Dosya Adı';
    $tr['en']['CreateNow']      = 'Şimdi Oluştur';             
    $tr['en']['Download']           = 'İndir';
    $tr['en']['Open']           = 'Aç';                   
    $tr['en']['UnZip']              = 'Zipden Çıkar';
    $tr['en']['UnZipToFolder']  = 'Zipten Klasöre Çıkar';        
    $tr['en']['Edit']               = 'Düzenle';
    $tr['en']['NormalEditor']   = 'Normal Editor';          
    $tr['en']['BackUp']             = 'Başa Dön';
    $tr['en']['SourceFolder']   = 'Kaynak Klasör';          
    $tr['en']['Files']              = 'Dosyalar';
    $tr['en']['Move']           = 'Taşı';                   
    $tr['en']['Change']             = 'Değiştir';
    $tr['en']['Settings']       = 'Ayarlar';               
    $tr['en']['Language']           = 'Dil';
    $tr['en']['Folder is empty']    = 'Klasör Boş'; 
    $tr['en']['Filter']    = 'Arama Yap';
    $tr['en']['PartitionSize']      = 'Boyut';
    $tr['en']['ErrorReporting'] = 'Hata Raporu';        
    $tr['en']['ShowHiddenFiles']    = 'Gizli Dosyaları Göster';
    $tr['en']['Help']               = 'Yardım';               
    $tr['en']['Created']    = 'Oluşturulma Tarihi';
    $tr['en']['Free of']        = 'Serbest Alan';                
    $tr['en']['Preview']            = 'Önizleme';
    $tr['en']['Help Documents'] = 'Help Documents';         
    $tr['en']['Report Issue']       = 'Report Issue';
    $tr['en']['Generate']       = 'Generate';               
    $tr['en']['FullSize']           = 'Tam Boyut';
    $tr['en']['FreeOf']         = 'free of';                
    $tr['en']['CalculateFolderSize']= 'Hesaplanan Klasör Boyutu';
    $tr['en']['HideColumns']    = 'İzinler Kolonunu Sakla/Göster';
    ...
    $tr['en']['Advanced Search']    = 'Gelişmiş Arama';    
    $tr['en']['Error while copying from']    = 'Kopyalama Sırasında Hata';
    $tr['en']['Nothing selected']   = 'Seçim Yapılmadı';   
    $tr['en']['Paths must be not equal']    = 'Dosya Yolu Boş Olamaz';
    $tr['en']['Renamed from']       = 'İsim Değiştirildi:';       
    $tr['en']['Archive not unpacked']       = 'Sıkıştırma Açılamadı';
    $tr['en']['Deleted']            = 'Silindi';            
    $tr['en']['Archive not created']        = 'Sıkıştırma Oluşturulamadı';
    $tr['en']['Copied from']        = 'Şu Alandan Kopyalandı:';        
    $tr['en']['Permissions changed']        = 'İzinler Değiştirildi';
    $tr['en']['to']                 = 'to';                 
    $tr['en']['Saved Successfully']         = 'Başarıyla Kaydedildi';
    $tr['en']['not found!']         = 'Bulunumadı!';         
    $tr['en']['File Saved Successfully']    = 'Dosya Başarıyla Kaydedildi';
    $tr['en']['Archive']            = 'Arşiv';            
    $tr['en']['Permissions not changed']    = 'Permissions not changed';
    $tr['en']['Select folder']      = 'Klasör Seç';      
    $tr['en']['Source path not defined']    = 'Source path not defined';
    $tr['en']['already exists']     = 'zaten mevcut';     
    $tr['en']['Error while moving from']    = 'Error while moving from';
    $tr['en']['Create archive?']    = 'Arşiv Oluşturulsun Mu?';    
    $tr['en']['Invalid file or folder name']    = 'Hata Dosya Ya da Klasör İsimi';
    ...
    $tr['en']['Selected files and folder deleted']              = 'Seçili dosya ya da klasör silindi!';
