...
if ($departman == "İNSAN KAYNAKLARI" || $role == "admin") {
$root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar';
    ...
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Ön Büro';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Ön Büro';
; }
...
; }
    ...
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Satın Alma';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Satın Alma';
; }

else if ($departman == "MUTFAK") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Mutfak';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Mutfak';
; }

else if ($departman == "HOUSE KEEPING") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/House Keeping';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/House Keeping';
; }

else if ($departman == "KALİTE YÖNETİMİ") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Kalite Yönetimi';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Kalite Yönetimi';
; }

else if ($departman == "MİSAFİR İLİŞKİLERİ") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Misafir İlişkileri';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Misafir İlişkileri';
; }

else if ($departman == "TEKNİK SERVİS") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Teknik Servis';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Teknik Servis';
; }

else if ($departman == "SATIŞ PAZARLAMA") {
    $root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Satış Pazarlama';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyalar/Satış Pazarlama';
; }
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Dosya Yönetim Sistemi';      $tr['en']['AppTitle']           = 'İnsan Kaynakları - Tutanak Yükleme';
