...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/portal/lagunabeachalya/dosyayonetim/bilgiislem/dosyalar';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/portal/lagunabeachalya/dosyayonetim/bilgiislem/dosyalar';
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Dosya Yönetim Sistemi';      $tr['en']['AppTitle']           = 'Dosya Yöneticisi';
