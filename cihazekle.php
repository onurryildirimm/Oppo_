...
<!-- ============================================================== -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Cihaz Ekleme Formu</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">VektraWeb</a></li>
                                        <li class="breadcrumb-item active">Cihaz Ekleme Formu</li>
                                    </ol>
                                </div>
  ...
  echo '
    ...
    <form action="cihaz_veri_aktar.php" method="POST" enctype="multipart/form-data">
...
<?php
  ...
  $statement = $pdoconnection->prepare("SELECT * FROM cihazlistesi ORDER BY id DESC");
  $statement->execute();
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   ...
   <div class="modal-body">
                          ...
                          <input type="text" onkeyup="value=value.toUpperCase();" name="cihaz" id="cihaz" class="form-control">  
                          <br />  
...
$('#action').click(function() {
 ...
 $(document).on('click', '.update', function(){
  ...
  form_data.append("cihaz", $("#cihaz").val());
 ...
 $(document).on('click', '.delete', function(){
  ...
  if(confirm("İlgili Kaydı Silmek İstediğinize Emin Misiniz?")) //Confim Box if OK then
  {
   ...
   $.ajax({
    url:"actioncihaz.php",    //Request send to "action.php page"
