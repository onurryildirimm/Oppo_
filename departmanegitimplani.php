...
<!-- ============================================================== -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Departman Eğitim Planı</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">VektraWeb</a></li>
                                        <li class="breadcrumb-item active">Departman Eğitim Planı</li>
                                    </ol>
                                </div>
 ...
 <div class="col-md-3">
  ...
  <div id="filterForm" class="collapse-form">
    <form action="departmanegitimplani" method="post">
...
<script>
  ...
  if ($user["role"] == "admin") {
    ...
    $query = "SELECT * FROM egitim WHERE departman = '" . $departman . "' AND 1=1";
} // Filtreleme için temel sorgu
...
$rows = getUserList($pdoconnection);
