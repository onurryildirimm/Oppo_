            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Dosya Yönetim Sistemi</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <iframe src="https://www.vektraweb.com.tr/portal/lagunabeachalya/dosyayonetim/insankaynaklari/dosyayonetim.php?p=" width="100%" height="500px" frameborder="0"></iframe>
