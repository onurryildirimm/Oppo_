                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Kontrol Formları</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Laguna Beach Alya</a></li>
                                        <li class="breadcrumb-item active">Ön Büro Kontrol Formları</li>
                                    </ol>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                            <h5><center>24:00 - 08:00 Periyodu Kontrol Formu</center></h5><hr>
                            <div class="row">
                                    <div class="col-md-4">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                    <div align="center">
                                                      <center>
                                    <a href="onburokontrol2408" class="btn btn-secondary btn-animation waves-effect waves-light" data-text="Yeni Kayıt Ekle">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                    <div align="center">
                                                      <center>
    <form action="onburo2408" method="post">
      <div>
        <label for="datepicker">Tarih Seçiniz:</label>
        <input type="date" id="datepicker" name="selectedDate" class="form-control" required>
      </div>
      <br>
      <button type="submit" class="btn btn-secondary btn-animation waves-effect waves-light">
        Tarihe Göre Sorgula
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                            <h5><center>08:00 - 16:00 Periyodu Kontrol Formu</center></h5><hr>
                            <div class="row">
                                    <div class="col-md-4">
                                        <div class="card card-animate">
                                            <div class="card-body">
      ...
      <button type="submit" class="btn btn-secondary btn-animation waves-effect waves-light">
        Tarihe Göre Sorgula
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                            <h5><center>16:00 - 24:00 Periyodu Kontrol Formu</center></h5><hr>
                            <div class="row">
                                    <div class="col-md-6">
                                        <div class="card card-animate">
                                            <div class="card-body">
