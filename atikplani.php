...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Atık Çizelgesi / Geri Dönüşüm Atık Verileri</h4>
            ...
            $aylar = getDistinctMonths($connection);

            // Atık miktarlarını veritabanından çek ve gruplayarak al
            $atikMiktarlari = getAtikMiktarlari($connection, $aylar);
            ?>

            <table class="table table-striped table-bordered" id="atikler_tablosu" style="background-color: white;">
                <thead>
                    <tr>
                        <th>Atık Türü</th>
                        <?php
...
<script>
  $(function () {
    $("#atikler_tablosu").DataTable({
      "responsive": true, "lengthChange": true, "autoWidth": false, "ordering": false,
      "buttons": [ "excel"]
    }).buttons().container().appendTo('#atikler_tablosu_wrapper .col-md-6:eq(0)');
  });
</script>   
...
<script>
    $(document).ready(function() {
        ...
        $('#atikler_tablosu').on('click', '.atik_miktari', function() {
            ...
            if (index === 19) { // Eğer tıklanan hücre tablonun ilk sütunundaysa, işlem yapmayın
                ...
                ay = $('#atikler_tablosu thead th').eq(index).data('ay');
            }
